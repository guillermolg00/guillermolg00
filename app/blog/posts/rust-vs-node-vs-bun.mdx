...
But if your team is 3 people who write TypeScript, your load is 10k msg/s, and the service runs on a $10/month pod — the pragmatic decision isn't the one that sells on Twitter.

I implemented it in Rust. I can say it works. I can also say that maintenance will be done by Vallin or Alain from the backend team, and they write JavaScript. A service that nobody can maintain isn't a good service, regardless of how many milliseconds of latency it saves.
